    ...
    <div class="box">
        <form enctype='multipart/form-data' method="post" action="confirmation.php">
            ...
            <div class="field">
                ...
                <div class="control">
                    <input name='name' class="input" type="text" placeholder="Joe Carlos" required>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <input name='area' class="input" type="text" placeholder="Sales" required>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <input name='phoneNumber' class="input" type="text" placeholder="(812)-345-7123" required>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <input name='email' class="input" type="text" placeholder="joe@dundmif.com" required>
                </div>
            </div>
